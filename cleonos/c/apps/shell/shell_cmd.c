...
static void ush_fastfetch_print_logo(int plain) {
    if (plain == 0) {
        ush_writeln("\x1B[1;34m      ____ _                 ___  ____  \x1B[0m");
        ush_writeln("\x1B[1;36m     / ___| | ___  ___ _ __ / _ \\/ ___| \x1B[0m");
        ush_writeln("\x1B[1;32m    | |   | |/ _ \\/ _ \\ '__| | | \\___ \\ \x1B[0m");
        ush_writeln("\x1B[1;33m    | |___| |  __/  __/ |  | |_| |___) |\x1B[0m");
        ush_writeln("\x1B[1;31m     \\____|_|\\___|\\___|_|   \\___/|____/ \x1B[0m");
    } else {
        ush_writeln("      ____ _                 ___  ____  ");
        ush_writeln("     / ___| | ___  ___ _ __ / _ \\/ ___| ");
        ush_writeln("    | |   | |/ _ \\/ _ \\ '__| | | \\___ \\ ");
        ush_writeln("    | |___| |  __/  __/ |  | |_| |___) |");
        ush_writeln("     \\____|_|\\___|\\___|_|   \\___/|____/ ");
    }
}
